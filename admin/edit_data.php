                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="edit_aksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Jenis UMKM</label>
                                        <div class="col-sm-8">
                                            <input name="kategori" class="form-control" type="text" id="kategori" type="text" value="<?php echo $data['kategori']; ?>" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
