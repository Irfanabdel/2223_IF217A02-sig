            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Data Tempat UMKM</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal style-form" style="margin-top: 10px;" action="tambah_aksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-4 control-label">Jenis UMKM</label>
                                    <div class="col-sm-6">
                                        <input name="kategori" class="form-control" type="text" type="text" placeholder="Jenis UMKM" required />
                                    </div>
                                </div>
                                <div class="form-group">
