...
<head>
  ...
  <title>SIG UMKM JAWA BARAT</title>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <h2>SIG UMKM Jawa Barat</h2>
            <h3>Sistem informasi ini merupakan aplikasi pemetaan geografis tempat umkm di wilayah Banyumas. Aplikasi ini memuat informasi dan lokasi dari tempat umkm di Banyumas.</h3>
          </div>
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center" data-aos="zoom-in">
          <h3>SISTEM INFORMASI GEOGRAFIS OBJEK umkm BANYUMAS</h3>
          <p> Detail tempat umkm di Banyumas</p>
        ...
        <div class="panel-body" style="align-content: center;">
          ...
          <script type="text/javascript">
            function initialize() {
              ...
              var mapOptions = {
                zoom: 16,
                center: new google.maps.LatLng(-6.8660393, 106.2853157),
        ...
        <div class="row">
          <div class="col-lg-3" data-aos="fade-right">
            <div class="section-title">
              <h2>Data umkm</h2>
              <p>Halaman ini memuat informasi Tempat umkm di Kabupaten Banyumas </p>
            </div>
          </div>
